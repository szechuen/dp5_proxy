...
class MetadataTest : public ::testing::Test, public DP5Params {
protected:
	string valid_metadata;

	virtual void SetUp(void) {
		int len = 2 + PRFKEY_BYTES + DP5Metadata::UINT_BYTES*4 + EPOCH_BYTES;
